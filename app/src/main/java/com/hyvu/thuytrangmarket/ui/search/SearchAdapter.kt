...
import com.hyvu.thuytrangmarket.databinding.ItemProductRowBinding
...
class SearchAdapter: RecyclerView.Adapter<SearchAdapter.ViewHolder>() {
    ...
    class ViewHolder(v: View): RecyclerView.ViewHolder(v) {
        var mBinding: ItemProductRowBinding = ItemProductRowBinding.bind(v)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_product_row, parent, false)
        return ViewHolder(v)
    }
