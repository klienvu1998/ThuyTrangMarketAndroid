...
fun Product.toProductEntity(isSync: Boolean, isDeleted: Boolean = false): ProductEntity {
    return ProductEntity(id, globalId, name, categoryId, description, price, isSync = isSync, isDeleted, slug)
}
